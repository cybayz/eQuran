...
return [
    ...
    "DATABASE_NAME" => "equran",
    "DATABASE_USERNAME" => "admin",
    "DATABASE_PASSWORD" => "SadmiNeQuran@786",
    // 
    // Cookie Config
    // =========================================================================
    "COOKIE_DEFAULT_EXPIRY" => 0,
    "COOKIE_USER" => "user",
    "" => "",
    // 
    // Session Config
    ...
    "TEXTS" => [
        ...
        // Login Model Texts
        // =====================================================================
        "LOGIN_INVALID_PASSWORD" => "The username / password combination you have entered is incorrect",
        "LOGIN_USER_NOT_FOUND" => "The Username you have entered has not been found!",
        "LOGIN_DETAILS_MISSING" => "Please provide a username/password",
        // 
        //
        // User Model Texts
        // =====================================================================
